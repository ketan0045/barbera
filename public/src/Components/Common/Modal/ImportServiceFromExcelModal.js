...
import "../../View/Service/stayle.css";
...
export default function ImportServiceFromExcelModal(props) {
  ...
  const handleSubmit = () => {
    ...
    ApiPost(`service/importExcel/service/${data.companyId}`, formData)
      .then((resp) => {
                      ...
                      <div className="rounded-lg shadow-lg relative staff-add-banner flex flex-col outline-none focus:outline-none">
                        <div className="modal-padding">
                          <div className="upload-file-text">
                            <h2>Upload a file</h2>
                            <p>
                              You can upload your excel sheet to import your
                              services
                            </p>
                            ...
                            <div className="modal-child-text">
                              <p>
                                Download a sample excel sheet that you can
                                populate with your data
                                <br />
                                Click{" "}
                                <a href="/files/service.xlsx" download>
                                  {" "}
                                  <b>here</b>{" "}
                                </a>{" "}
                                to download
