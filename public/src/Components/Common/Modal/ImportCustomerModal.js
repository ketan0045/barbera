...
import "../../View/Customer/stayle.css";
...
export default function ImportCustomerModal(props) {
  ...
  const handleSubmit = () => {
    ...
    ApiPost(`customer/importExcel/customer/${data.companyId}`, formData)
      .then((resp) => {
                          ...
                          <div className="upload-file-text">
                            ...
                            <div className="modal-child-text">
                              <p>
                                ...
                                <br />
                                Click{" "}
                                <a href="/files/customer.xlsx" download>
                                  {" "}
                                  <b> here</b>{" "}
                                </a>{" "}
                                to download
