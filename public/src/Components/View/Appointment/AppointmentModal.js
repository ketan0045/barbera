...
const AppointmentModal = (props) => {
  const { modal, toggle, object, getAll, details,SettingInfo } = props;
  ...
  const getStoreSetting = async (values) => {
    const SettingData = get_Setting()
      ...
      setStoreTiming(SettingData.storeTiming[0]);
  ...
  const dateHandler = async (e) => {
    let isDayAvail = moment(e).format("dddd");
  ...
  const handleMultipleSubmit = async () => {
    try {
      ...
      if (res.data.status === 200) {
        toast.success(object ? "Updated Successfully" : "Added Successfully", {
          position: "top-center",
          autoClose: 2000,
  ...
  const appointmentSchema = Yup.object().shape({
    name: Yup.string().trim().required("This Customer Does Not Exist"),
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      if (multipleServicesData.length === 0) {
        setFirstTime(times);
      }
      if (isValid) {
        setTimeMsg("");
        ...
        if (multipleClicked === true) {
          ...
          let res;
          object
            ? (res = await ApiPut("appointment/" + object._id, data))
            : (res = await ApiPost("appointment/", data));
          try {
            if (res.data.status === 200) {
              toast.success(
  ...
  return (
    <div>
      {modal ? (
        <>
          <div className="">
            <div className="animation justify-center items-center mx-auto flex oflex fixed inset-0 z-50 outline-none focus:outline-none">
              {createCustomerModal && (
                <CreateCustomer
                  mobile={mobile}
              ...
              >
                ...
                <div
                  className={
                    ...
                    (multipleServices ? "multipal-appoitment-height-modal" : "")
                  }
                >
                  {/*header*/}
                  ...
                  <div className="md:flex mini-device-height-set">
                    <div
                      className={
                        multipleServices
                          ? "md:w-2/5 appotment-right-border"
                          : "md:w-full"
                      }
                    >
                      <form>
                        ...
                        <div class="overflow-hidden sm:rounded-md">
                          <div class="pl-5 pr-5">
                            <div className="md:flex md:w-full mb-3">
                              <div>
                                <Radio
                            ...
                            <div class="grid grid-cols-12">
                              ...
                              <div class="col-span-12 sm:col-span-12 p-2 flex items-center create-customer-checkbox">
                                ...
                                <input
                                  ...
                                  disabled={multipleServices ? true : false}
                                />
                                <span class="ml-2 confirmation-text-color">
                        ...
                        <div className="md:w-full modal-subheading-height mb-3">
                          <div className="flex items-center">
                            ...
                            <span className="font-size-20 heading-title-text-color font-bold tracking-normal pl-4">
                              {multipleServicesData &&
                              multipleServicesData.length
                                ? multipleServicesData[0] &&
                                  new Date(
                                    multipleServicesData[0].date
                                  ).toDateString()
                                : ""}
                            </span>
                          </div>
