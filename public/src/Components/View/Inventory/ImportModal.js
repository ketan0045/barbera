...
export default function CreateProduct(props) {
  ...
  const handleSubmit = () => {
    ...
    ApiPost(`product/importExcel/product/${data.companyId}`, formData)
      .then((resp) => {
        toggle(resp.data.status)
        // if (resp.data.status === 200) {
        //   toggle(resp.data.status);
        //   setNotification(toast.success("New data added!", {
        //     position: "top-center",
        //     autoClose: 2000,
        ...
        //     }))
        // } else {
        //   setNotification(toast.warn("Please enter correct data", {
        //     position: "top-center",
        //     autoClose: 2000,
        //     hideProgressBar: true,
        //     closeOnClick: true,
                ...
                <div className="rounded-lg shadow-lg relative staff-add-banner flex flex-col outline-none focus:outline-none">
                  <div className="modal-padding">
                    <div className="upload-file-text">
                      <h2>Upload a file</h2>
                      <p>
                        You can upload your excel sheet to import your products
                      </p>
                      ...
                      <div className="modal-child-text">
                        <p>
                          ...
                          with your data
                          <br />
                          Click <a href='' download> <b>here</b> </a> to download
                        </p>
                      </div>
